...
class GraphWindow(Gtk.Window):
    def __init__(self, input_text, selected_gadget):
        ...
        self.ax.grid(True)
        self.ax.legend()
        self.ax.set_xlabel('Итерации (Номер)')
        ...
        self.timeout_id = GLib.timeout_add_seconds(10, self.update_lines_with_speed)
...
#sudo python3 /home/alexander/Desktop/VSCodeProjects/testpy/window.py
#sudo python3 /home/alexander/Desktop/VSCodeProjects/testpy/test.py                  
